...
def main():
    ...
    daftar_barang = [
        Barang("B001", "Moisturizer", 50000),
        Barang("B002", "Toner", 30000),
        Barang("B003", "Serum", 70000),
        Barang("B004", "Sunscreen", 65000),
        Barang("B005", "Facial Wash", 55000),
        Barang("B006", "Masker", 45000),
    ]
